...
export default function DocColorPickerPage() {
  const [label, setLabel] = useState("Couleur");
  ...
  return (
    <div className="doc-page">
      ...
      <div className="sandbox-container">
        ...
        <div className="sandbox-controls">
          <div className="sandbox-control-group">
            <label>label</label>
            <input type="text" value={label} onChange={(e) => setLabel(e.target.value)} placeholder="Couleur" />
          </div>
          <div className="sandbox-control-group">
      ...
      <table className="props-table">
        ...
        <tbody>
          <tr><td><code>label</code></td><td><code>string</code></td><td>—</td><td>Non</td><td>Label au-dessus du sélecteur.</td></tr>
          <tr><td><code>value</code></td><td><code>string</code></td><td>#000000</td><td>Non</td><td>Couleur au format hex (#RRGGBB).</td></tr>
          ...
          <tr><td><code>disabled</code></td><td><code>boolean</code></td><td>false</td><td>Non</td><td>Désactive le sélecteur.</td></tr>
        </tbody>
      </table>
