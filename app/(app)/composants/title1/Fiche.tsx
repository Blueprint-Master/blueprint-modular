...
const fr = {
  ...
  sizeDesc: "Taille CSS — surcharge le défaut du niveau 1.",
  ...
  logoUrlDesc: "URL d'un logo affiché à gauche (spécifique au niveau 1).",
  onLogoClickDesc: "Callback au clic sur le logo.",
  note1: "Toutes les props de ",
  note2: " s'appliquent, à l'exception de ",
  note3: " qui est fixé à 1.",
  examples: "Exemples",
};

const en: typeof fr = {
  breadcrumb: "Components",
  desc1: "Level 1 heading (h1, 1.875rem, weight 700). Shorthand for ",
  desc2: " with ",
  desc3: " preset: same options (bold, color, bar, inverted), without having to specify the level.",
  category: "Data display",
  demoTitle: "Annual report 2025",
  boldLabel: "bold (optional)",
  boldDefault: "Level default (700)",
  boldYes: "Yes (700)",
  boldNo: "No (400)",
  ...
  sizeDesc: "CSS size — overrides the level 1 default.",
  ...
  logoUrlDesc: "URL of a logo displayed on the left (level 1 only).",
  onLogoClickDesc: "Callback when the logo is clicked.",
  note1: "All props of ",
  note2: " apply, except ",
  note3: ", which is fixed to 1.",
  examples: "Examples",
};
    ...
    <div className="doc-page">
      <div className="doc-page-header">
        <div className="doc-breadcrumb">
          <Link href="/composants">{t.breadcrumb}</Link> → bpm.title1
        </div>
        <h1>bpm.title1</h1>
        <p className="doc-description">
          {t.desc1}
          <Link href="/composants/title">bpm.title</Link>
          {t.desc2}
          <code>level=1</code>
          {t.desc3}
        </p>
      ...
      <table className="props-table">
        ...
        <tbody>
          ...
          <tr><td><code>size</code></td><td><code>string</code></td><td>1.875rem</td><td>{t.no}</td><td>{t.sizeDesc}</td></tr>
          <tr><td><code>bold</code></td><td><code>boolean | number</code></td><td>700</td><td>{t.no}</td><td>{t.boldDesc}</td></tr>
          ...
          <tr><td><code>logoUrl</code></td><td><code>string</code></td><td>—</td><td>{t.no}</td><td>{t.logoUrlDesc}</td></tr>
          <tr><td><code>onLogoClick</code></td><td><code>() =&gt; void</code></td><td>—</td><td>{t.no}</td><td>{t.onLogoClickDesc}</td></tr>
        </tbody>
      </table>
