...
export default function DocTitle3Page() {
  const [children, setChildren] = useState("Détail par région");
    ...
    <div className="doc-page">
      <div className="doc-page-header">
        <div className="doc-breadcrumb">
          <Link href="/docs/components">Composants</Link> → bpm.title3
        </div>
        <h1>bpm.title3</h1>
        <p className="doc-description">
          Titre de niveau 3 (h3, 1.25rem, gras 600). Raccourci de{" "}
          <Link href="/docs/components/title">bpm.title</Link> avec <code>level=3</code> préréglé :
      ...
      <table className="props-table">
        ...
        <tbody>
          ...
          <tr><td><code>size</code></td><td><code>string</code></td><td>1.25rem</td><td>Non</td><td>Taille CSS — surcharge le défaut du niveau 3.</td></tr>
      ...
      <p className="text-sm mt-2">
        ...
        à l&apos;exception de <code>level</code> qui est fixé à 3 (et de <code>logoUrl</code>,
        réservé au niveau 1).
      </p>
