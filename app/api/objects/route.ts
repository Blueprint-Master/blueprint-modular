...
export async function GET(){return NextResponse.json({schemaVersion:1,objects:DISCOVERABLE_OBJECTS.map(o=>({...o,version:o.family==="space"?UNIVERSE_VERSION:o.version,
  ...
  variants:o.family==="science"?["midnight","paper"]:o.family==="space"||o.family==="weather"||o.family==="forms"||o.family==="water"||o.family==="flora"||o.family==="materials"?["photorealistic","illustration"]:["vector"],animated:o.family==="space"||o.family==="weather"||o.family==="forms"||o.family==="water"||o.family==="flora"||o.family==="materials"||o.family==="science",
