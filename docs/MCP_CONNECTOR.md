...
- **Endpoint** : `POST /api/mcp` (prod : `https://mcp.blueprint-modular.com/api/mcp`)
...
3. **Remote MCP server URL** : `https://mcp.blueprint-modular.com/api/mcp`
...
3. **MCP Server URL** : `https://mcp.blueprint-modular.com/api/mcp`, **Auth : None**.
