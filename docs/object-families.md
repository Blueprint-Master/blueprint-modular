...
Mis à jour le **2026-09-18**. Cet index décrit le code et sa validation, pas une
...
| Drapeaux — candidat | `flag-banner@1.0.0`, 311 motifs dont 50 États US et UE ; réaliste/dessin, fixe/flottant, 4 calques, 3 fonds | Implémenté en branche ; hors découverte par défaut. Afghanistan, ONU et autres organisations reportés. Validation visuelle live requise ; ni npm ni production. [Détails](flags.md) |
