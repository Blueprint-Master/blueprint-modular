...
| Météo & atmosphères | `weather-sun`, `weather-fair`, `weather-overcast`, `weather-rain`, `weather-storm`, `weather-snow` ; chacun réaliste + gouache ; 1.0.0 | Cinq objets fusionnés via Modular #220/#222/#223 et Maker #1929/#1933. `weather-sun` créé sur `feat/weather-sun-20260911` ; revue live non validée. [Preuves](previews/weather-sun/README.md). Non publié npm ni disponible en production par cette passe |
