...
const FR = { title:"Objets", intro:"Vingt objets réutilisables, un langage visuel commun. Explorez, ajustez, puis composez votre expérience.",
  catalogue:"CATALOGUE", all:"Tout", space:"Espace", buildings:"Bâtiments", mobility:"Mobilité", logistics:"Logistique", search:"Rechercher un objet", empty:"Aucun objet ne correspond à cette recherche.",
...
const EN: typeof FR = { title:"Objects", intro:"Twenty reusable objects, one visual language. Explore, adjust, then compose your experience.",
  catalogue:"CATALOGUE", all:"All", space:"Space", buildings:"Buildings", mobility:"Mobility", logistics:"Logistics", search:"Find an object", empty:"No objects match this search.",
...
export function ObjectsCatalogue() {
  ...
  return <>
    <CatalogueHero
      ...
      title={S.title}
      lead={S.intro}
      meta={`${MODULAR_OBJECTS.length} ${S.count}`}
    />
