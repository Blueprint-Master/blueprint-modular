...
export const bpm = {
  ...
  locationField: wrap(LocationField),
  machineStatus: wrap(MachineStatus),
  map: wrap(Map),
  mapView: wrap(MapView),
  skyMap: wrap(SkyMap),
  celestialBody: wrap(CelestialBody),
  celestialScene: wrap(CelestialScene),
  orbitalSystem: wrap(OrbitalSystem),
  solarSystem: wrap(SolarSystem),
  galaxyView: wrap(GalaxyView),
  moonPhase: wrap(MoonPhase),
  aircraftMarker: wrap(AircraftMarker),
  flightMap: wrap(FlightMap),
  flightInstruments: wrap(FlightInstruments),
  flightProfile: wrap(FlightProfile),
  airportBoard: wrap(AirportBoard),
  seatMap: wrap(SeatMap),
  cartographicMap: wrap(CartographicMap),
  mapLayerControl: wrap(MapLayerControl),
  mapLegend: wrap(MapLegend),
