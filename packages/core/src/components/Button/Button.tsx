...
function Spinner({ size = 14 }: { size: number }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      style={{
        animation: "bpm-button-spin 0.75s linear infinite",
        flexShrink: 0,
      }}
      aria-hidden
    >
...
const ICONS: Record<string, IconRenderer> = {
  ...
  open_in_new: (s) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6M15 3h6v6M10 14L21 3"/></svg>,
  ...
  edit: (s) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>,
  search: (s) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>,
  ...
  return (
    <>
      ...
      >
        ...
        {children != null && (
          <span style={{ opacity: loading ? 0.65 : 1 }}>{children}</span>
        )}
