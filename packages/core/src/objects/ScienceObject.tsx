...
export function ScienceObject({id,label,locale="fr",size=360,style="midnight",thumbnail=false,playing=true,interactive=true,element="C",compareElement="O",colorMode="category",layers,atomic,molecule,onElementChange}:ScienceObjectProps){
