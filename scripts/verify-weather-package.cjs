...
assert.equal(objects.WEATHER_IDS.length,5);
...
console.log('PASS: public package exports, 10 exact references, SSR posters, selected materials and lazy renderer chunk. No npm publication.');
