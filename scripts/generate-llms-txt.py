...
Science 1.0.0: `ScienceObject`, `ScienceControls`, `SCIENCE_IDS`, `SCIENCE_OBJECTS` and the complete 118-element `ELEMENTS` data set are exported from /objects. IDs: science-periodic-table, science-atom, science-element-card, science-comparator. Styles: midnight and paper. The structure, identity, classification, guides and analysis layers are independently configurable. Selected element, comparison element, colour mode and layers survive the strict data-only `.modular.json` reference and Maker packaging. Periodic identities and positions follow IUPAC's 4 May 2022 release and NIST references. The atom is a labelled pedagogical density view, not a quantum calculation or a view to scale. Fixed SVG previews load without raster or third-party assets. Browser and physical-mobile review remain required before this candidate leaves draft.
