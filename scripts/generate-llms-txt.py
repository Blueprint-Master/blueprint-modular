...
Science 1.0.0: ScienceObject, ScienceControls, SCIENCE_IDS and the 118-element ELEMENTS model are exported from /objects. IDs: science-periodic-table, science-atom, science-element-card, science-comparator, science-molecule. Styles: midnight, paper, transparent. AtomicDensityLayer, AtomSphereLayer and MoleculeLayer are background-free composable SVG groups. Optional atomic settings (density/sphere, density/nucleus visibility, opacity) and molecule settings (preset or validated data-only graph, orientation, atom/bond/label/measurement visibility) roundtrip via .modular.json into Maker. Molecular presets: water, carbon-dioxide, methane, ammonia; individual NIST CCCBDB gas-phase Cartesian coordinates in angstroms, with CPK symbolic colours/radii. Custom graphs support 24 atoms/48 bonds and ten common elements; edits are labelled unvalidated, not chemically optimised. Preserve source coordinates; do not infer a geometry from a formula. No quantum density or orbital calculation, no fabricated electron motion; stationary models have zero animation loops. See docs/scientific-composition.md and docs/previews/science/README.md for sources and validation limits.
