...
const fr = {
  ...
  status: {
    ...
    bannerDegraded: "Dégradation partielle détectée",
    bannerOutage: "Panne de service détectée",
    bannerNoData: "Collecte de disponibilité en cours",
    services: {
      vitrine: "Vitrine",
      mcp: "Connecteur MCP",
    },
    levelOperational: "Opérationnel",
    levelDegraded: "Dégradé",
    levelOutage: "En panne",
    levelNoData: "Pas de données",
    ninetyDaysAgo: "Il y a 90 jours",
    today: "Aujourd'hui",
    uptimeSuffix: "% de disponibilité",
    collectingNote: "Collecte en cours — l'historique se remplit à chaque mesure.",
    todayTitle: "Aujourd'hui",
    metricChecks: "Mesures",
    metricUptime: "Disponibilité",
    metricLatency: "Latence",
    metricLastCheck: "Dernière mesure",
    incidentsTitle: "Historique des incidents",
    incidentsNone: "Aucun incident sur les 30 derniers jours",
    incidentResolved: "Résolu",
    incidentOngoing: "En cours",
    footerNote: "Disponibilité mesurée toutes les 5 minutes",
    none: "—",
  },
  home: {
  ...
  galleryPage: {
    ...
    next: "Carte suivante",
    viewDetail: "Voir la chaîne de génération",
