...
const en: Dictionary = {
  ...
  status: {
    ...
    bannerDegraded: "Partial degradation detected",
    bannerOutage: "Service outage detected",
    bannerNoData: "Availability collection in progress",
    services: {
      vitrine: "Website",
      mcp: "MCP connector",
    },
    ...
    today: "Today",
    uptimeSuffix: "% uptime",
    collectingNote: "Collection in progress — history fills in with every check.",
    todayTitle: "Today",
    metricChecks: "Checks",
    metricUptime: "Uptime",
    metricLatency: "Latency",
    metricLastCheck: "Last check",
    incidentsTitle: "Incident history",
    incidentsNone: "No incidents in the last 30 days",
    incidentResolved: "Resolved",
    incidentOngoing: "Ongoing",
    footerNote: "Availability measured every 5 minutes",
    none: "—",
  },
  home: {
  ...
  galleryPage: {
    ...
    eyebrow: "The gallery",
    title: "Applications built with .Modular",
    // Subtitle split into prefix + link text + suffix: the « .Maker » segment
    // becomes a link (rendered in the component), with no raw HTML in the translation.
    leadBefore: "Generated by ",
    leadMakerLink: ".Maker",
    leadAfter: ", born from a simple prompt.",
    empty:
    ...
    prev: "Previous card",
    next: "Next card",
    viewDetail: "See the generation chain",
    // Detail view /galerie/[id] — prompt → structure → app chain
    detailMetaTitle: "{title} — Modular Gallery",
    detailBack: "← Back to the gallery",
    detailLead: "One sentence produced this structure, deterministically.",
    stepPromptTitle: "The request",
    stepStructureTitle: "The generated structure",
    stepAppTitle: "The application",
    narrative:
      "From the sentence above, Modular deterministically derived this structure — entities, modules and metrics.",
    entitiesTitle: "Entities",
    modulesTitle: "Modules",
    kpisTitle: "Metrics",
    fieldColLabel: "Field",
    fieldColType: "Type",
    fieldColRequired: "Required",
    requiredYes: "Required",
    requiredNo: "Optional",
    fieldsCount: "{n} fields",
    moduleColLabel: "Module",
    moduleColEntity: "Entity",
    noEntity: "—",
  },
  changelogPage: {
    title: "Changelog",
